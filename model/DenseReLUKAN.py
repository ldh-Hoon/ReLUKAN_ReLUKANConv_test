...
class DenseReLUKAN(nn.Module):
    def __init__(self, input_shape=784, hidden_shape=64, output_shape=10, num_layers=4, g=5, k=3):
        super(DenseReLUKAN, self).__init__()
        ...
        self.layers.append(ReLUKANLayer(input_shape, g, k, hidden_shape))

        for i in range(num_layers):
            self.layers.append(ReLUKANLayer(hidden_shape, g, k, hidden_shape))
        ...
        self.fc_out = ReLUKANLayer(hidden_shape, g, k, output_shape)  
